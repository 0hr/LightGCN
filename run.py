...
def parse_args(argv=None):
    ...
    # xGCN
    parser.add_argument("--ref_hidden", type=float, default=1024, help="FFN hidden dim")
    parser.add_argument("--snn-hidden", type=float, default=32, help="SNN hidden dim")
    parser.add_argument("--xgcn-K", type=int, default=10, help="of warm-up refreshes")
    parser.add_argument("--xgcn-T", type=int, default=3, help="# epochs between refresh in warm-up")
    parser.add_argument("--xgcn-tolerance", type=int, default=3, help="epochs w/o improvement to trigger refresh after warm-up")

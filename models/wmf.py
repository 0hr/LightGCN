...
from sampler import Sampler  # if unused you can remove
from utils import *          # expects set_seed, load_dataset, evaluate, tqdm, trange, etc.
...
class WMF(nn.Module):
    """
    Implicit Weighted Matrix Factorization (Hu et al.)
...
def run_wmf(args, seed, device):
    ...
    # Cap batch size for dense matrix operations to avoid OOM
    BATCH_LIMIT = 4096
    ...
    # FIXED: use ceil so we don't drop users at the end
